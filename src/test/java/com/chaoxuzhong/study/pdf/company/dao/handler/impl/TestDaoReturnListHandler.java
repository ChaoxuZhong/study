...
@Service(TestConstantForCompare.TESTDAO_RETURNLIST_HANDLER)
public class TestDaoReturnListHandler extends DefaultPdfDaoHandler implements IPdfDaoHandler {
    ...
    protected String getDbName() {
        return TestConstantForCompare.TESTDAO_RETURNLIST_DBNAME;
    }

    @Override
    protected Object getDataFromDb(String memberNo) {
        return forTestDbService.getDbNormalList();
    }
